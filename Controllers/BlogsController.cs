...
namespace blogging_platform.Controllers
{
    public class BlogsController : Controller
    {
        ...
        // GET: Blogs
        public async Task<IActionResult> SearchBlogs(string SearchPhrase)
        {
            return View("Index", await _context.Blog.Where(j => (j.content.Contains(SearchPhrase) || j.title.Contains(SearchPhrase))).ToListAsync());
        }
